...
class CashCardWizard(models.TransientModel):
    ...
    def send_sale_report(self):
        ...
        report_id = 'sales_report_cash_card.sales_report'
    ...
    def sale_report(self):
        ...
        return self.env.ref('sales_report_cash_card.sales_report').report_action(self, data=data)


class ReportSale(models.AbstractModel):

    _name = 'report.sales_report_cash_card.sales_report_pdf'
