...
class GeneralConsent(models.TransientModel):
    _name = 'general.consent'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_general_consent(self.register_date, wizard_vals)


class ReportGeneralConsent(models.AbstractModel):
    _name = 'report.consent_management.report_general_consent_pdf'
