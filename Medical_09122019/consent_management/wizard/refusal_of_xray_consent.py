...
class RefusalOfXrayConsent(models.TransientModel):
    _name = 'refusal.of.xray.consent'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_refusal_of_xray_consent(self.register_date, wizard_vals)


class ReportRefusalOfXrayConsent(models.AbstractModel):
    _name = 'report.consent_management.report_refusal_of_xray_consent_pdf'
    ...
    def get_report_values(self, docids, data=None):
        ...
        return {
            'doc_ids': self.ids,
            'doc_model': 'refusal.of.xray.consent',
            'data': data,
            'docs': docs,
