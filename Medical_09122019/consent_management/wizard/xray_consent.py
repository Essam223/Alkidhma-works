...
class XrayConsent(models.TransientModel):
    _name = 'xray.consent'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_xray_consent(self.register_date, wizard_vals)


class ReportXrayConsent(models.AbstractModel):
    _name = 'report.consent_management.report_xray_consent_pdf'
