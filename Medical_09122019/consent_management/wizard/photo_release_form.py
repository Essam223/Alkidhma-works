...
class PhotoRelease(models.TransientModel):
    _name = 'photo.release'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_photo_release(self.register_date, wizard_vals)


class ReportPhotoRelease(models.AbstractModel):
    _name = 'report.consent_management.report_photo_release_pdf'
