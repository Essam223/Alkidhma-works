...
class RequestToReleaseRecords(models.TransientModel):
    _name = 'cosmetic.treatment.consent'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_cosmetic_treatment_consent(self.register_date, wizard_vals)


class ReportReleaseRecords(models.AbstractModel):
    _name = 'report.consent_management.report_cosmetic_treatment_pdf'
