...
class OralSurgeryConsent(models.TransientModel):
    _name = 'oral.surgery.consent'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_Oral_Surgery_Consent(self.register_date, wizard_vals)


class ReportOralSurgeryConsent(models.AbstractModel):
    _name = 'report.consent_management.report_oral_surgery_consent_pdf'
    ...
    def get_report_values(self, docids, data=None):
        ...
        return {
            'doc_ids': self.ids,
            'doc_model': 'oral.surgery.consent',
            'data': data,
            'docs': docs,
