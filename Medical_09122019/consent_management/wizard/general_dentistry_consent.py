...
class GeneralDentistryConsent(models.TransientModel):
    _name = 'general.dentistry.consent'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_general_dentistry_consent(self.register_date, wizard_vals)


class ReportGeneralDentistryConsent(models.AbstractModel):
    _name = 'report.consent_management.report_general_dentistry_consent_pdf'
    ...
    def get_report_values(self, docids, data=None):
        ...
        return {
            'doc_ids': self.ids,
            'doc_model': 'general.dentistry.consent',
            'data': data,
            'docs': docs,
