...
class EndodonticTreatmentForm(models.TransientModel):
    _name = 'endodontic.treatment.form'
    ...
    def action_confirm(self):
        ...
        self.patient_id.attach_EndodonticTreatmentForm(self.register_date, wizard_vals)


class ReportEndodonticTreatmentForm(models.AbstractModel):
    _name = 'report.consent_management.report_endodontic_treatment_pdf'
    ...
    def get_report_values(self, docids, data=None):
        ...
        return {
            'doc_ids': self.ids,
            'doc_model': 'endodontic.treatment.form',
            'data': data,
            'docs': docs,
