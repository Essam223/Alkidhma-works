...
class PurchaseReport(models.Model):
    ...
    cost_center_id = fields.Many2one('account.cost.center', 'Cost Center', readonly=True)
        ...
        self._cr.execute("""
            create view purchase_report as (
                ...
                from purchase_order_line l
                    ...
                    left join account_cost_center cost_center on (l.cost_center_id = cost_center.id)
